...
- `dev_zero_shot_control`: 1 control on the exact tuning dev subset;
- `mezo_zo_eps_sweep`: 6 dev-only LoRA/Prefix finite-difference jobs;
- `head_dp_batch_sweep`: 2 dev-only Head batch-size jobs;
